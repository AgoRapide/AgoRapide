...
PLEASE NOTE: AgoRapide is currently in the alpha-stage of development. Only use it if you are curious and / or want to help is with contributions. 
...
It is on our todo-list. We are concerned about how to implement client-friendly error messages though for invalid parameter values.
