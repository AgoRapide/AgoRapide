...
namespace AgoRapide {
    ...
    public abstract class ApplicationPart : BaseEntityWithLogAndCount {
        ...
        protected static T GetOrAdd<T>(BaseAttribute attribute, IDatabase db, T enrichAndReturnThisObject) where T : ApplicationPart, new() {
            ...
            var retvalTemp = AllApplicationParts.GetOrAdd(attribute.IdentifierAndName.Identifier, i => {
                ...
                cid = thisA.IdentifierAndName.Identifier.Equals(i) ?
            ...
            if (retval == null) throw new InvalidObjectTypeException(retvalTemp, typeof(T),
                nameof(attribute.IdentifierAndName) + ": " + attribute.IdentifierAndName + ", " + nameof(retvalTemp) + ": " + retvalTemp.ToString() + "\r\n" +
                "Possible cause: Duplicate identifiers generated by different instances of " + nameof(BaseAttribute.IdentifierAndName));
            ...
            AllApplicationParts[attribute.IdentifierAndName.Identifier] = enrichAndReturnThisObject;
