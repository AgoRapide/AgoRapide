...
namespace AgoRapide.API {
    public abstract class BaseController : ApiController {
        ...
        public object AgoRapideGenericMethod(APIMethod method, BaseEntityT currentUser) {
            ...
            if (exactMatch != null) {
                if (exactMatch.Item1.Origin != APIMethodOrigin.Autogenerated) throw new Request.MethodMatchingException("Found " + nameof(exactMatch) + " for " + exactMatch.Item1.Name + " with " + nameof(exactMatch.Item1.Origin) + " " + exactMatch.Item1.Origin + ". These methods are supposed to be handled by the 'ordinary' API .NET routing mechanism.");
                ...
                switch (candidateMatches.Item1.Count) {
                    ...
                    case 1: {
                            var retval = new APIMethodCandidate(request, candidateMatches.Item1[0], candidateMatches.Item2);
                ...
                request.Result.MultipleEntitiesResult = maybeIntended.Item1.Select(m => (BaseEntityT)m).ToList();
        ...
        public object HandleCoreMethodUpdateProperty(APIMethod method, string id, string key, string value) {
            ...
            var queryId = request.Parameters.PVM<QueryId>();
            var tPropertyKey = request.Parameters.PV<CoreProperty>(M(CoreProperty.Key));
            ...
            switch (queryId) {
                case IntegerQueryId integerQueryId: request.Result.AddProperty(M(CoreProperty.SuggestedUrl), request.CreateAPIUrl(method.EntityType, integerQueryId.Id)); break;
            }
        ...
        protected bool TryGetRequest(
            ...
            var parameters = new Dictionary<CoreProperty, Property>();
        ...
        /// <param name="caller"></param>
        /// <returns></returns>
        protected long GetId([System.Runtime.CompilerServices.CallerMemberName] string caller = "") => ApplicationPart.GetOrAdd<ClassAndMethod>(GetType(), caller, DB).Id;
