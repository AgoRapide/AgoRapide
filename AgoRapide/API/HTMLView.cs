...
namespace AgoRapide.API {
    ...
    public class HTMLView : BaseView { 
        ...
        public virtual string GetHTMLStart() =>
            ...
            "</title>\r\n" +
            "<link rel=\"stylesheet\" type=\"text/css\" href=\"" + Util.Configuration.CA.RootUrl + Util.Configuration.CA.CSSRelativePath + "\">\r\n" +
            string.Join("", Util.Configuration.CA.ScriptRelativePaths.Select(s => "<script src=\"" + Util.Configuration.CA.RootUrl + s + "\"></script>\r\n")) +
                "</head>\r\n" +
            "<body>\r\n" +
            "<div style=\"display:none\" id=\"hiddenDiv\"></div>" + // Dummy element used for JQuery html / text conversion

            // TODO: Make this static. 
            "<h1><a href=\"" + Util.Configuration.CA.RootUrl + "\">AgoRapide</a></h1>\r\n" +
