    ...
    public static class APIMethodMapper { 
        ...
        public static void MapHTTPRoutes(
            ...
            if (genericMethod.RouteTemplates != null && string.Join(",", genericMethod.RouteTemplates) != Util.Configuration.GenericMethodRouteTemplate) {
                throw new APIMethod.MethodInitialisationException(typeof(CoreMethod) + "." + genericMethod.A.A.CoreMethod + "'s " + nameof(APIMethod.RouteTemplates) + " should have been set to " + nameof(Configuration) + "." + nameof(Configuration.GenericMethodRouteTemplate) + " (" + Util.Configuration.GenericMethodRouteTemplate + "), not " + string.Join(",", genericMethod.RouteTemplates) + ". This is most probably a bug in AgoRapide framework");
            }
