...
namespace AgoRapide.API {
    ...
    public static class APIMethodMapper { 
        ...
        public static void MapHTTPRoutes(
            ...
            tempMapper(rootIndex, nameof(CoreAPIMethod) + "_" + CoreAPIMethod.RootIndex + "_" + Util.Configuration.A.HTMLPostfixIndicatorWithoutLeadingSlash, Util.Configuration.A.HTMLPostfixIndicatorWithoutLeadingSlash, rootIndex.Defaults);
            ...
            if (genericMethod.RouteTemplates != null && string.Join(",", genericMethod.RouteTemplates) != Util.Configuration.A.GenericMethodRouteTemplate) {
                throw new APIMethod.MethodInitialisationException(typeof(CoreAPIMethod) + "." + genericMethod.A.CoreMethod + "'s " + nameof(APIMethod.RouteTemplates) + " should have been set to " + nameof(ConfigurationAttribute) + "." + nameof(ConfigurationAttribute.GenericMethodRouteTemplate) + " (" + Util.Configuration.A.GenericMethodRouteTemplate + "), not " + string.Join(",", genericMethod.RouteTemplates) + ". This is most probably a bug in AgoRapide framework");
            }
            tempMapper(genericMethod, nameof(CoreAPIMethod) + "_" + CoreAPIMethod.GenericMethod, Util.Configuration.A.GenericMethodRouteTemplate, genericMethod.Defaults);
