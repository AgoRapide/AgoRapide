...
namespace AgoRapide.API {
    ...
    public class APIMethod : ApplicationPart {
        ...
        public APIMethod(bool requiresAuthorization, Type entityType, APIMethodAttribute methodAttribute, List<HTTPMethod> httpMethods, List<RouteSegmentClass> routeSegments, System.Reflection.MethodInfo baseEntityMethod) : base(methodAttribute) {
        ...
        /// </param>
        public static void CreateAutogeneratedMethods(List<Type> types, BaseDatabase db) {
            ...
            types.ForEach(t => {
                ...
                t.GetMethods().ForEach(methodInfo => {
                    ...
                    var method = new APIMethod(
                        ...
                        //parameters: new Func<List<PropertyKey>>(() => {
                        //    var retval = new List<PropertyKey> {
                        //        CoreP.QueryId.A()
                        //    };
                        //    retval.AddRange(routeSegments.Where(s => s.Parameter != null).Select(s => s.Parameter));
                        //    return retval;
                        //})(),
                        // routeTemplate: string.Join("/", routeSegments.Select(s => s.Template)),
        ...
        private static void FilterConnectWithDatabaseAndAddMethod(APIMethod method, BaseDatabase db) {
