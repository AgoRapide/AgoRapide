        ...
        private static void FilterConnectWithDatabaseAndAddMethod(APIMethod method, IDatabase db) {
            ...
            var identifier = new Func<string>(() => {
                switch (method.MA.CoreMethod) {
                    case CoreAPIMethod.RootIndex:
                    case CoreAPIMethod.GenericMethod: return method.MA.CoreMethod.ToString();
            ...
            switch (method.MA.CoreMethod) {
                case CoreAPIMethod.RootIndex: updater(CoreP.Name, "(" + method.MA.CoreMethod + ")"); break;
                case CoreAPIMethod.GenericMethod: updater(CoreP.Name, method.RouteTemplates[0] + " (" + method.MA.CoreMethod + ")"); break;
