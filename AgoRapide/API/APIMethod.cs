...
namespace AgoRapide.API {
    ...
    public class APIMethod : ApplicationPart {
        ...
        public APIMethod(Type entityType, APIMethodAttribute methodAttribute, List<HTTPMethod> httpMethods, List<RouteSegmentClass> routeSegments, List<PropertyKey> parameters, string routeTemplate) {
            ...
            method.A.Properties.Values.ForEach(p => {
                if (typeof(bool).Equals(p.Key.Key.A.Type)) {
                    ...
                    if (method.A.CoreMethod != CoreAPIMethod.None) {
                        ...
                        var coreA = method.A.CoreMethod.GetEnumValueAttribute();
