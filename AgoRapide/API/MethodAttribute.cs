...
namespace AgoRapide.API {
    ...
    /// 
    /// See slightly more refined class <see cref="MethodAttributeT{TProperty}"/>
    /// 
    ...
    public class MethodAttribute : Attribute {
        ...
        /// <summary>
        /// Route segment 1. Turned into <see cref="RouteSegmentClass{TProperty}"/> by <see cref="APIMethod{TProperty}.CreateSemiAutogeneratedMethods"/>
        /// </summary>
        public object S1 { get; set; }

        /// <summary>
        /// Route segment 2. Turned into <see cref="RouteSegmentClass{TProperty}"/> by <see cref="APIMethod{TProperty}.CreateSemiAutogeneratedMethods"/>
        /// </summary>
        public object S2 { get; set; }

        /// <summary>
        /// Route segment 3. Turned into <see cref="RouteSegmentClass{TProperty}"/> by <see cref="APIMethod{TProperty}.CreateSemiAutogeneratedMethods"/>
        /// </summary>
        public object S3 { get; set; }

        /// <summary>
        /// Route segment 4. Turned into <see cref="RouteSegmentClass{TProperty}"/> by <see cref="APIMethod{TProperty}.CreateSemiAutogeneratedMethods"/>
        /// </summary>
        public object S4 { get; set; }

        /// <summary>
        /// Route segment 5. Turned into <see cref="RouteSegmentClass{TProperty}"/> by <see cref="APIMethod{TProperty}.CreateSemiAutogeneratedMethods"/>
        /// </summary>
        public object S5 { get; set; }

        /// <summary>
        /// Route segment 6. Turned into <see cref="RouteSegmentClass{TProperty}"/> by <see cref="APIMethod{TProperty}.CreateSemiAutogeneratedMethods"/>
        /// </summary>
        public object S6 { get; set; }

        /// <summary>
        /// Route segment 7. Turned into <see cref="RouteSegmentClass{TProperty}"/> by <see cref="APIMethod{TProperty}.CreateSemiAutogeneratedMethods"/>
        /// </summary>
        public object S7 { get; set; }

        /// <summary>
        /// Route segment 8. Turned into <see cref="RouteSegmentClass{TProperty}"/> by <see cref="APIMethod{TProperty}.CreateSemiAutogeneratedMethods"/>
        /// </summary>
        public object S8 { get; set; }

        /// <summary>
        /// Route segment 9. Turned into <see cref="RouteSegmentClass{TProperty}"/> by <see cref="APIMethod{TProperty}.CreateSemiAutogeneratedMethods"/>
        /// </summary>
        public object S9 { get; set; }

        /// <summary>
        /// <see cref="Request{TProperty}.CurrentUser"/> (<see cref="BaseEntity.AccessLevelGiven"/>) must by equal to <see cref="MethodAttribute.AccessLevelUse"/> or HIGHER in order for access to be granted to <see cref="APIMethod{TProperty}"/>
        /// </summary>
        public AccessLevel AccessLevelUse { get; set; } = AccessLevel.User;

        /// <summary>
        /// TRUE means that detailed result information like <see cref="Result{TProperty}.LogData"/> and <see cref="Result{TProperty}.Counts"/> 
        ...
        /// <see cref="Result{TProperty}.ToHTMLDetailed"/> could add this, since it knows request, parameters and so on.
        /// Typical would be to replace {id} in this string with result values like <see cref="CoreProperty.Id"/>. 
        /// We could also add this to <see cref="Result{TProperty}.ToJSONDetailed"/>
        /// </summary>
