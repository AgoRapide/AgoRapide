...
namespace AgoRapide {
    ...
    /// </summary>
    [Enum(
        Description = "Describes how a given -" + nameof(APIMethod) + "- was constructed.",
        LongDescription =
            "-" + nameof(Autogenerated) + "- and -" + nameof(SemiAutogenerated) + "- " +
    ...
    public enum APIMethodOrigin {
        ...
        [EnumValue(
            ...
            LongDescription =
                ...
                "(which handles {*url} in order to recognize which internal method (-" + nameof(CoreAPIMethod) + "-) to call. " +
                "\r\n" +
        ...
        [EnumValue(
            ...
            LongDescription =
                "This is done by using the -" + nameof(APIMethodAttribute) + "--class in order to tag the Controller's action (method) with " +
                "the different -" + nameof(RouteSegmentClass) + "--classes " +
                "(-" + nameof(APIMethodAttribute.S1) + "-, -" + nameof(APIMethodAttribute.S2) + "- and so on) " +
