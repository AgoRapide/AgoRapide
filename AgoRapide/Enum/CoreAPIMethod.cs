...
namespace AgoRapide {
    ...
    public enum CoreAPIMethod {
        ...
        /// <summary>
        /// See <see cref="BaseController.HandleCoreMethodAPIDataObjectMethod"/>
        /// </summary>
        [EnumValue(Description ="Practical shortcut enabling -" + nameof(APIDataObject) + "- classes to 'directly' receive API calls without creating a correponding Controller-method")]
        APIDataObjectMethod,
