...
namespace AgoRapide {
    ...
    public enum CoreMethod {
        ...
        /// </summary>
        [EnumMember(Description = "\"Starting point\" for API. Will usually return HTML-format regardless of -" + nameof(ResponseFormat) + "- requested by client")]
        RootIndex,

        [EnumMember(Description ="Access to -" + nameof(Configuration) + "-.")]
        Configuration,
        ...
        /// </summary>
        [EnumMember(Description = "Basic access to entities.")]
        EntityIndex,

        [EnumMember(Description = "Adding of entities. Corresponding -" + nameof(APIMethodOrigin.Autogenerated) + "- -" +nameof(APIMethod) + "- will get parameters according to -" + nameof(Extensions.GetObligatoryChildProperties) + "-")]
        AddEntity,
