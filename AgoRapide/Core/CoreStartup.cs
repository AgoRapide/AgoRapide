...
namespace AgoRapide.Core {
    ...
    public class CoreStartup {
        ...
        /// <summary>
        /// </summary>
        /// <typeparam name="TPerson">Assigned to <see cref="ConfigurationAttribute.TPersonType"/></typeparam>
        ...
        public System.Web.Http.HttpConfiguration Initialize<TPerson>(
            ...
            Util.Configuration.C.TPersonType = typeof(TPerson);
            ...
            { /// Create all combinations of <see cref="AggregationKey"/> for <see cref="CountP"/>
                ...
                Util.EnumGetValues<CountP>().ForEach(c => {
                    var attribute = c.A();
                    APIMethod.AllBaseEntityDerivedTypes.ForEach(t => {
            ...
            Log("EntityRelations", "\r\n\r\nEntity relation traversals found:" + string.Join("", APIMethod.AllBaseEntityDerivedTypes.OrderBy(t => t.ToStringVeryShort()).Select(t => "\r\nFrom: " + t + ": " +
