...
namespace AgoRapide.Core {
    ...
    public class ConfigurationAttribute : BaseAttribute { /// NOTE: This class does not use any <see cref="Attribute"/> functionality
        ...
        [ClassMember(Description = "Database login role used for ALTER TABLE xx OWNER TO in autogenerated SQL")]
        public string DatabaseObjectsOwner { get; set; } = "agorapide";

        [ClassMember(Description = "Name of main table in database. Also used for naming other objects in database like sequence_p_id.")]
        public string DatabaseTableName { get; set; } = "p";
