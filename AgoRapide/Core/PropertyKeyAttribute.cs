...
namespace AgoRapide.Core {
    ...
    public class PropertyKeyAttribute : EnumValueAttribute {
        ...
        /// 
        /// Note that for dynamically originated attributes (see <see cref="PropertyKeyAttributeEnrichedDyn"/>) this
        ...
        [ClassMember(
            ...
            LongDescription =
                "Used for -" + nameof(CoreAPIMethod.AddEntity) + "- (-" + nameof(APIMethodOrigin.Autogenerated) + "- -" + nameof(APIMethod) + ")- in order to construct necessary parameters. " +
        ...
        /// for every enum for which no <see cref="PropertyKeyAttribute"/> is defined.             
        /// 
        /// Usually called from <see cref="Extensions.GetAgoRapideAttributeT{T}(T)"/> / <see cref="Extensions.GetAgoRapideAttribute(object)"/>. 
        /// </summary>
        /// <param name="_enum"></param>
        /// <returns></returns>
        public static PropertyKeyAttribute GetAgoRapideAttribute(object _enum) {
            ...
            if (type.GetEnumAttribute().EnumTypeY != EnumType.PropertyKey) throw new InvalidObjectTypeException(_enum, EnumType.PropertyKey + " required here");
