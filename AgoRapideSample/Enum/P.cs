...
namespace AgoRapideSample {
    ...
    public enum P {
        ...
        /// </summary>
        [PropertyKey(Group = typeof(PersonPropertiesDescriber), Type = typeof(string))]
        FirstName,
        ...
        [PropertyKey(Group = typeof(PersonPropertiesDescriber), Type = typeof(DateTime), DateTimeFormat = DateTimeFormat.DateOnly)]
        DateOfBirth,
        ...
        /// </summary>
        [PropertyKey(Parents = new Type[] { typeof(Person) }, InheritAndEnrichFromProperty = CoreP.Username)]
        Email,

        [PropertyKey(Group = typeof(PersonPropertiesDescriber), InheritAndEnrichFromProperty = CoreP.Password)]
        Password,

        [PropertyKey(Group = typeof(PersonPropertiesDescriber), InheritAndEnrichFromProperty = CoreP.EntityToRepresent)]
        EntityToRepresent,

        [PropertyKey(Parents = new Type[] { typeof(Person) }, InheritAndEnrichFromProperty = CoreP.AccessLevelGiven)]
        AccessLevelGiven,

        [PropertyKey(Parents = new Type[] { typeof(Person) }, InheritAndEnrichFromProperty = CoreP.RepresentedByEntity)]
        RepresentedByEntity,

        [PropertyKey(Parents = new Type[] { typeof(Person) }, InheritAndEnrichFromProperty = CoreP.RejectCredentialsNextTime)]
        RejectCredentialsNextTime,

        [PropertyKey(Parents = new Type[] { typeof(Person) }, InheritAndEnrichFromProperty = CoreP.AuthResult)]
        AuthResult,
