    ...
    public class HomeController : BaseController {
        ...
        public object AddFirstAdminUser(string Email, string Password) {
            try {
                ...
                if (au == null) throw new Exception(nameof(Util.Configuration.C.AnonymousUser) + " not set up correctly (null)");
                if (au.Id <= 0) throw new Exception(nameof(Util.Configuration.C.AnonymousUser) + " not set up correctly (" + nameof(au.Id) + ": " + au.Id + ")");
                if (!au.GetType().Equals(typeof(Person))) throw new Exception(nameof(Util.Configuration.C.AnonymousUser) + " not set up correctly (type: " + au.GetType() + ")");
