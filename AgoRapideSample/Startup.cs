    ...
    public class Startup {
        ...
        public void Configuration(Owin.IAppBuilder appBuilder) {
            try {
                ...
                void mapper1<T>() where T : struct, IFormattable, IConvertible, IComparable => AgoRapide.Core.EnumMapper.MapEnum<T>(s => {
                    // return; // TODO: ENABLE LOGGIN HERE. We have a serious chicken and egg problem now.
                    Log(nameof(AgoRapide.Core.EnumMapper.MapEnum) + ": " + s);
                ...
                Log("Calling " + nameof(AgoRapide.Core.EnumValue.RegisterAndIndexEnumClass));
                AgoRapide.Core.EnumValue.RegisterAndIndexEnumClass<P>(db); // TODO: Make more logical choice of methdod names and placing of logic
